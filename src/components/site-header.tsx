...
export function SiteHeader() {
  ...
  return <header className="sticky top-0 z-50 border-b border-[var(--line)] bg-[color:var(--bg)]/92 backdrop-blur-xl" onKeyDown={(event) => { if (event.key === "Escape") setOpen(false); }}>
    <div className="container flex h-16 items-center justify-between gap-3 sm:h-18 sm:gap-4">
    ...
    {open && <nav id="mobile-navigation" aria-label="Mobile navigation" className="container grid max-h-[calc(100vh-4rem)] gap-1 overflow-y-auto pb-4 sm:max-h-[calc(100vh-4.5rem)] sm:pb-5 xl:hidden">
