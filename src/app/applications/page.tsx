...
export default function Applications() {
  return <><PageHero eyebrow="Live application portfolio" title="Technical projects you can open and examine." description="Each deployment is paired with its public source repository, practical purpose, key features, and current status."/><section className="section"><div className="container">
