export const currentResearch = {
  ...
  datasetPreparation: ["Prepare Khmer physics word problems and structured solution components", "Organize given information, formulas, calculations, and explanations for evaluation", "Add verified dataset size, source, and preparation protocol"],
  fineTuningApproach: ["Use instruction fine-tuning for Khmer physics problem solving", "Add verified base-model and training-configuration details"],
  ...
  currentProgress: ["Research is in progress", "Add research timeline", "Add verified methodology details"],
  results: ["Add confirmed evaluation results"],
  limitations: ["Add verified limitations after evaluation"],
  ...
  futureWork: ["Add future work after methodology and evaluation are confirmed"],
