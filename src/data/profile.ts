export const profile = {
  ...
  availability: "Open to research collaboration and knowledge exchange",
  focus: ["Banking analytics", "Applied machine learning", "Business intelligence", "Khmer NLP"],
  goals: ["Develop responsible AI and analytics for financial services", "Contribute to research in Khmer NLP and applied machine learning", "Prepare for future doctoral research and international collaboration"],
};
export const skills = {
  "Data Analytics": ["Python","Pandas","NumPy","Excel","SQL"],
  "Machine Learning": ["Scikit-learn","Regression","Classification","Clustering","Forecasting","Model evaluation"],
  Visualization: ["Power BI","Plotly","Matplotlib"],
  "Application Development": ["Streamlit","GitHub","APIs","PostgreSQL"],
  Research: ["Literature review","Experiment design","Academic writing","Model evaluation"],
  Business: ["Banking operations","Product analysis","Customer experience","Channel performance","Requirement analysis"],
};
